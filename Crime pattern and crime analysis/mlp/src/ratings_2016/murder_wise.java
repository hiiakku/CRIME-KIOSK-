...
public class murder_wise {
    ...
    public static void main( String [] args ) {
        ...
        try {
             ...
             InputStream input = new BufferedInputStream(
                        new FileInputStream("C:\\Users\\admin\\Desktop\\SM\\sem6-2018\\java\\crime2016.xls"));
 ...
 Iterator rows1 = sheet.rowIterator();
            ...
            while( rows.hasNext() ) {  
                ...
                HSSFCell cellSomething;
                // sum = cell0.getNumericCellValue(row.getCell(0));
                cellSomething = row.getCell(minColIx);
                sum = (int)cellSomething.getNumericCellValue();*/
                sum = 0;
                while( cells.hasNext() ) {
                    HSSFCell cell = (HSSFCell) cells.next();
                    if(HSSFCell.CELL_TYPE_NUMERIC==cell.getCellType()){
            ...
            System.out.println();
            System.out.println();
            System.out.println("MURDER wise sorted state %s");
            System.out.println();
            SortedSet<Map.Entry<String,Double>> list =entriesSortedByValues(map);
            Iterator it = list.iterator();
            it.next();
            int k=1;
            System.out.println("Rank    State       % of murder cases ");
