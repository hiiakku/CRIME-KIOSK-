...
public class kidnapping_and_abduction_wise {
 ...
 Iterator rows1 = sheet.rowIterator();
            ...
            System.out.println();
            System.out.println();
            System.out.println("Kidnapping & Abduction wise sorted state %s");
            System.out.println();
            SortedSet<Map.Entry<String,Double>> list =entriesSortedByValues(map);
            Iterator it = list.iterator();
            it.next();
            int k=1;
            System.out.println("Rank    State      % Kidnapping & Abduction cases ");
