		...
		<div>
		 <form id="form1" method="post" action="viewcomplaintreply.jsp">
            ...
            try {
                ...
                ResultSet rs = st.executeQuery("select district,Nameofpolicestation,datem,namaddr from missingperson");
                String district = "", Nameofpolicestation = "", datem = "",namaddr="";
                                        %>          
                                        ...
                                        <table width="485" height="28" border="0">
                                            ...
                                            while (rs.next()) {
                                              district = rs.getString("district");
                                               Nameofpolicestation  = rs.getString("Nameofpolicestation");
                                              datem = rs.getString("datem");
											  namaddr = rs.getString("namaddr");
                                                
                                                out.println("<tr>");
                                                out.println("<td>" + district + "</td>");
                                                out.println("<td>" + Nameofpolicestation + "</td>");
