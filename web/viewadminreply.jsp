...
out.write("<table width=\"376\" border=\"1\"><tr><td width=\"163\">Userid</td><td width=\"197\"><label><input type=\"text\" name=\"user\"  value="+ a +"></label></td></tr><tr><td>Complaintid</td><td><label><input type=\"text\" name=\"complaintid\" value=" + b +"></label></td></tr><tr><td>Take Action </td><td><label><input type=\"text\" name=\"takeaction\" value=" + c +"></label></td></tr></table>");
                }
        %> 
              </form>
